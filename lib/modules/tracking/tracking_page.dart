...
class _TrackingPageState extends State<TrackingPage> {
  ...
  bool _showFilters = true; // mengikuti gaya DAB: panel filter terlihat saat masuk
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            TextButton.icon(
                              ...
                              icon: const Icon(Icons.refresh, size: 18, color: Color(0xFF7E57C2)),
                              label: const Text('Reset', style: TextStyle(color: Color(0xFF7E57C2))),
                            ),
                          ],
                        ),
                      ],
